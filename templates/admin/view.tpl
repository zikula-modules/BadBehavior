...
<table class="z-datatable">
    ...
    <tbody>
        ...
        <tr class="{cycle values="z-odd,z-even"}">
            ...
            <td class="z-right"><a href='{modurl modname='BadBehavior' type='admin' func='display' id=$i.id}'>{img modname='core' set='icons/extrasmall' src='14_layer_visible.png' __title='View' __alt='View' class='tooltips'}</a></td>
        </tr>
        {foreachelse}
